      ...
      <div className="flex justify-end items-center relative">
        ...
        >
          {answerLoading ? (
            ...
            <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" class="mr-1" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
