...
function _render(props, slot = {}, tag, name) {
  ...
  if (Component === import_react13.Fragment) {
    if (Object.keys(compact(rest)).length > 0) {
      ...
      let newClassName = classNames((_a3 = resolvedChildren.props) == null ? void 0 : _a3.className, rest.className);
...
function useFlags(initialFlags = 0) {
  ...
  let addFlag = (0, import_react35.useCallback)((flag) => setFlags((flags2) => flags2 | flag), [flags]);
  let hasFlag = (0, import_react35.useCallback)((flag) => Boolean(flags & flag), [flags]);
  let removeFlag = (0, import_react35.useCallback)((flag) => setFlags((flags2) => flags2 & ~flag), [setFlags]);
  let toggleFlag = (0, import_react35.useCallback)((flag) => setFlags((flags2) => flags2 ^ flag), [setFlags]);
...
function SwitchFn(props, ref) {
  ...
  (0, import_react38.useEffect)(() => {
    var _a3;
    let form = (_a3 = internalSwitchRef.current) == null ? void 0 : _a3.closest("form");
    if (!form)
      return;
